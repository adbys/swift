...
class PodcastsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let podcastCell = cell as? PodcastTableViewCell {
            ...
            podcastCell.fotoDoPodcast.image = UIImage(named: podcast.imagem)
            
            podcastCell.nomeDoPodcast.text = podcast.nome
            
            podcastCell.descricaoPodcast.text = podcast.descricao
